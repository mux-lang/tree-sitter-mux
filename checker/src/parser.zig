...
pub const anon_sym_STAR: c_int = 1;
pub const anon_sym_SLASH: c_int = 2;
pub const anon_sym_PLUS: c_int = 3;
pub const anon_sym_DASH: c_int = 4;
pub const sym_identifier: c_int = 5;
pub const sym_number: c_int = 6;
pub const sym_SourceFile: c_int = 7;
pub const sym__Expression: c_int = 8;
pub const sym_Operation: c_int = 9;
pub const sym_Multiplication: c_int = 10;
pub const sym_Division: c_int = 11;
pub const sym_Addition: c_int = 12;
pub const sym_Subtraction: c_int = 13;
const enum_unnamed_7 = c_uint;
pub const ts_symbol_names: [14][*c]const u8 = [14][*c]const u8{
    "end",
    "*",
    "/",
    "+",
...
pub const ts_symbol_map: [14]TSSymbol = [14]TSSymbol{
    0,
    @bitCast(TSSymbol, @truncate(c_short, anon_sym_STAR)),
    @bitCast(TSSymbol, @truncate(c_short, anon_sym_SLASH)),
    @bitCast(TSSymbol, @truncate(c_short, anon_sym_PLUS)),
    @bitCast(TSSymbol, @truncate(c_short, anon_sym_DASH)),
    @bitCast(TSSymbol, @truncate(c_short, sym_identifier)),
    @bitCast(TSSymbol, @truncate(c_short, sym_number)),
    @bitCast(TSSymbol, @truncate(c_short, sym_SourceFile)),
    @bitCast(TSSymbol, @truncate(c_short, sym__Expression)),
    @bitCast(TSSymbol, @truncate(c_short, sym_Operation)),
    @bitCast(TSSymbol, @truncate(c_short, sym_Multiplication)),
    @bitCast(TSSymbol, @truncate(c_short, sym_Division)),
    @bitCast(TSSymbol, @truncate(c_short, sym_Addition)),
    @bitCast(TSSymbol, @truncate(c_short, sym_Subtraction)),
};
pub const ts_symbol_metadata: [14]TSSymbolMetadata = [14]TSSymbolMetadata{
    TSSymbolMetadata{
        .visible = @as(c_int, 0) != 0,
        .named = @as(c_int, 1) != 0,
        .supertype = false,
    },
    TSSymbolMetadata{
        .visible = @as(c_int, 1) != 0,
        .named = @as(c_int, 0) != 0,
        .supertype = false,
    },
    TSSymbolMetadata{
...
pub const field_operator: c_int = 1;
const enum_unnamed_8 = c_uint;
pub const ts_field_names: [2][*c]const u8 = [2][*c]const u8{
    null,
    "operator",
};
pub const ts_field_map_slices: [2]TSFieldMapSlice = [2]TSFieldMapSlice{
    @import("std").mem.zeroes(TSFieldMapSlice),
    TSFieldMapSlice{
        .index = @bitCast(u16, @truncate(c_short, @as(c_int, 0))),
        .length = @bitCast(u16, @truncate(c_short, @as(c_int, 1))),
    },
};
pub const ts_field_map_entries: [1]TSFieldMapEntry = [1]TSFieldMapEntry{
    TSFieldMapEntry{
        .field_id = @bitCast(TSFieldId, @truncate(c_short, field_operator)),
        .child_index = @bitCast(u8, @truncate(i8, @as(c_int, 1))),
        .inherited = false,
    },
};
pub const ts_alias_sequences: [2][3]TSSymbol = [1][3]TSSymbol{
    [1]TSSymbol{
        0,
    } ++ [1]TSSymbol{0} ** 2,
} ++ [1][3]TSSymbol{@import("std").mem.zeroes([3]TSSymbol)} ** 1;
pub const ts_non_terminal_alias_map: [1]u16 = [1]u16{
    0,
};
pub const ts_primary_state_ids: [13]TSStateId = [13]TSStateId{
    0,
    1,
    2,
    3,
    ...
    11,
    12,
}; // ./tree_sitter/parser.h:138:3: warning: TODO implement translation of stmt class GotoStmtClass
// parser.c:170:13: warning: unable to translate function, demoted to extern
pub extern fn ts_lex(arg_lexer: [*c]TSLexer, arg_state: TSStateId) callconv(.C) bool;
pub const ts_lex_modes: [13]TSLexMode = [13]TSLexMode{
    TSLexMode{
        .lex_state = @bitCast(u16, @truncate(c_short, @as(c_int, 0))),
...
pub const ts_parse_table: [6][14]u16 = [6][14]u16{
    [7]u16{
        1,
        1,
        1,
...
pub const ts_small_parse_table: [68]u16 = [68]u16{
    5,
    13,
    1,
    0,
    15,
    1,
    @bitCast(u16, @truncate(c_short, anon_sym_STAR)),
    17,
    1,
    @bitCast(u16, @truncate(c_short, anon_sym_SLASH)),
    19,
    1,
    @bitCast(u16, @truncate(c_short, anon_sym_PLUS)),
    21,
    1,
    @bitCast(u16, @truncate(c_short, anon_sym_DASH)),
    1,
    23,
    5,
    0,
...
pub const ts_small_parse_table_map: [7]u32 = [7]u32{
    0,
    16,
    24,
    32,
...
pub const ts_parse_actions: [35]TSParseActionEntry = [35]TSParseActionEntry{
    TSParseActionEntry{
        .entry = struct_unnamed_6{
            .count = @bitCast(u8, @truncate(i8, @as(c_int, 0))),
            .reusable = @as(c_int, 0) != 0,
        },
    },
    TSParseActionEntry{
        .entry = struct_unnamed_6{
            .count = @bitCast(u8, @truncate(i8, @as(c_int, 1))),
            .reusable = @as(c_int, 0) != 0,
        },
    },
    TSParseActionEntry{
        .action = TSParseAction{
            .@"type" = @bitCast(u8, @truncate(i8, TSParseActionTypeRecover)),
        },
    },
    TSParseActionEntry{
        .entry = struct_unnamed_6{
            .count = @bitCast(u8, @truncate(i8, @as(c_int, 1))),
            .reusable = @as(c_int, 1) != 0,
        },
    },
    TSParseActionEntry{
        .action = TSParseAction{
            .shift = struct_unnamed_4{
                .@"type" = @bitCast(u8, @truncate(i8, TSParseActionTypeShift)),
                .state = @bitCast(TSStateId, @truncate(c_short, @as(c_int, 6))),
                .extra = false,
                .repetition = false,
            },
        },
    ...
    TSParseActionEntry{
        .action = TSParseAction{
            .shift = struct_unnamed_4{
                .@"type" = @bitCast(u8, @truncate(i8, TSParseActionTypeShift)),
                .state = @bitCast(TSStateId, @truncate(c_short, @as(c_int, 8))),
                .extra = false,
                .repetition = false,
            },
        },
    ...
    TSParseActionEntry{
        .action = TSParseAction{
            .shift = struct_unnamed_4{
                .@"type" = @bitCast(u8, @truncate(i8, TSParseActionTypeShift)),
                .state = @bitCast(TSStateId, @truncate(c_short, @as(c_int, 9))),
                .extra = false,
                .repetition = false,
            },
        },
    ...
    TSParseActionEntry{
        .action = TSParseAction{
            .shift = struct_unnamed_4{
                .@"type" = @bitCast(u8, @truncate(i8, TSParseActionTypeShift)),
                .state = @bitCast(TSStateId, @truncate(c_short, @as(c_int, 10))),
                .extra = false,
                .repetition = false,
            },
        },
    ...
    TSParseActionEntry{
        .action = TSParseAction{
            .shift = struct_unnamed_4{
                .@"type" = @bitCast(u8, @truncate(i8, TSParseActionTypeShift)),
                .state = @bitCast(TSStateId, @truncate(c_short, @as(c_int, 11))),
                .extra = false,
                .repetition = false,
            },
        },
    ...
    TSParseActionEntry{
        .action = TSParseAction{
            .reduce = struct_unnamed_5{
                .@"type" = @bitCast(u8, @truncate(i8, TSParseActionTypeReduce)),
                .child_count = @bitCast(u8, @truncate(i8, @as(c_int, 1))),
                .symbol = @bitCast(TSSymbol, @truncate(c_short, sym_SourceFile)),
    ...
    TSParseActionEntry{
        .action = TSParseAction{
            .shift = struct_unnamed_4{
                .@"type" = @bitCast(u8, @truncate(i8, TSParseActionTypeShift)),
                .state = @bitCast(TSStateId, @truncate(c_short, @as(c_int, 2))),
                .extra = false,
                .repetition = false,
            },
        },
    ...
    TSParseActionEntry{
        .action = TSParseAction{
            .shift = struct_unnamed_4{
                .@"type" = @bitCast(u8, @truncate(i8, TSParseActionTypeShift)),
                .state = @bitCast(TSStateId, @truncate(c_short, @as(c_int, 3))),
                .extra = false,
                .repetition = false,
            },
        },
    ...
    TSParseActionEntry{
        .action = TSParseAction{
            .shift = struct_unnamed_4{
                .@"type" = @bitCast(u8, @truncate(i8, TSParseActionTypeShift)),
                .state = @bitCast(TSStateId, @truncate(c_short, @as(c_int, 4))),
                .extra = false,
                .repetition = false,
            },
        },
    ...
    TSParseActionEntry{
        .action = TSParseAction{
            .shift = struct_unnamed_4{
                .@"type" = @bitCast(u8, @truncate(i8, TSParseActionTypeShift)),
                .state = @bitCast(TSStateId, @truncate(c_short, @as(c_int, 5))),
                .extra = false,
                .repetition = false,
            },
        },
    ...
    TSParseActionEntry{
        .action = TSParseAction{
            .reduce = struct_unnamed_5{
                .@"type" = @bitCast(u8, @truncate(i8, TSParseActionTypeReduce)),
                .child_count = @bitCast(u8, @truncate(i8, @as(c_int, 1))),
                .symbol = @bitCast(TSSymbol, @truncate(c_short, sym_Operation)),
                .dynamic_precedence = 0,
                .production_id = 0,
            },
        },
    ...
    TSParseActionEntry{
        .action = TSParseAction{
            .reduce = struct_unnamed_5{
                .@"type" = @bitCast(u8, @truncate(i8, TSParseActionTypeReduce)),
                .child_count = @bitCast(u8, @truncate(i8, @as(c_int, 3))),
                .symbol = @bitCast(TSSymbol, @truncate(c_short, sym_Multiplication)),
                .dynamic_precedence = 0,
                .production_id = @bitCast(u16, @truncate(c_short, @as(c_int, 1))),
            },
        },
    },
    TSParseActionEntry{
    ...
    TSParseActionEntry{
        .action = TSParseAction{
            .reduce = struct_unnamed_5{
                .@"type" = @bitCast(u8, @truncate(i8, TSParseActionTypeReduce)),
                .child_count = @bitCast(u8, @truncate(i8, @as(c_int, 3))),
                .symbol = @bitCast(TSSymbol, @truncate(c_short, sym_Division)),
                .dynamic_precedence = 0,
                .production_id = @bitCast(u16, @truncate(c_short, @as(c_int, 1))),
            },
        },
    ...
    TSParseActionEntry{
        .action = TSParseAction{
            .reduce = struct_unnamed_5{
                .@"type" = @bitCast(u8, @truncate(i8, TSParseActionTypeReduce)),
                .child_count = @bitCast(u8, @truncate(i8, @as(c_int, 3))),
                .symbol = @bitCast(TSSymbol, @truncate(c_short, sym_Addition)),
                .dynamic_precedence = 0,
                .production_id = @bitCast(u16, @truncate(c_short, @as(c_int, 1))),
            },
        },
    ...
    TSParseActionEntry{
        .action = TSParseAction{
            .reduce = struct_unnamed_5{
                .@"type" = @bitCast(u8, @truncate(i8, TSParseActionTypeReduce)),
                .child_count = @bitCast(u8, @truncate(i8, @as(c_int, 3))),
                .symbol = @bitCast(TSSymbol, @truncate(c_short, sym_Subtraction)),
                .dynamic_precedence = 0,
                .production_id = @bitCast(u16, @truncate(c_short, @as(c_int, 1))),
            },
        },
    ...
    TSParseActionEntry{
        .action = TSParseAction{
            .@"type" = @bitCast(u8, @truncate(i8, TSParseActionTypeAccept)),
        },
    },
};
pub fn tree_sitter_mux() callconv(.C) [*c]const TSLanguage {
    const language = struct {
        const static: TSLanguage = TSLanguage{
            .version = @bitCast(u32, @as(c_int, 14)),
            .symbol_count = @bitCast(u32, @as(c_int, 14)),
            .alias_count = @bitCast(u32, @as(c_int, 0)),
            .token_count = @bitCast(u32, @as(c_int, 7)),
            .external_token_count = @bitCast(u32, @as(c_int, 0)),
            .state_count = @bitCast(u32, @as(c_int, 13)),
            .large_state_count = @bitCast(u32, @as(c_int, 6)),
            .production_id_count = @bitCast(u32, @as(c_int, 2)),
            .field_count = @bitCast(u32, @as(c_int, 1)),
            .max_alias_sequence_length = @bitCast(u16, @truncate(c_short, @as(c_int, 3))),
            .parse_table = &ts_parse_table[@intCast(c_uint, @as(c_int, 0))][@intCast(c_uint, @as(c_int, 0))],
            .small_parse_table = @ptrCast([*c]const u16, @alignCast(@import("std").meta.alignment([*c]const u16), &ts_small_parse_table)),
            .small_parse_table_map = @ptrCast([*c]const u32, @alignCast(@import("std").meta.alignment([*c]const u32), &ts_small_parse_table_map)),
            .parse_actions = @ptrCast([*c]const TSParseActionEntry, @alignCast(@import("std").meta.alignment([*c]const TSParseActionEntry), &ts_parse_actions)),
            .symbol_names = @ptrCast([*c]const [*c]const u8, @alignCast(@import("std").meta.alignment([*c]const [*c]const u8), &ts_symbol_names)),
            .field_names = @ptrCast([*c]const [*c]const u8, @alignCast(@import("std").meta.alignment([*c]const [*c]const u8), &ts_field_names)),
            .field_map_slices = @ptrCast([*c]const TSFieldMapSlice, @alignCast(@import("std").meta.alignment([*c]const TSFieldMapSlice), &ts_field_map_slices)),
            .field_map_entries = @ptrCast([*c]const TSFieldMapEntry, @alignCast(@import("std").meta.alignment([*c]const TSFieldMapEntry), &ts_field_map_entries)),
            .symbol_metadata = @ptrCast([*c]const TSSymbolMetadata, @alignCast(@import("std").meta.alignment([*c]const TSSymbolMetadata), &ts_symbol_metadata)),
            .public_symbol_map = @ptrCast([*c]const TSSymbol, @alignCast(@import("std").meta.alignment([*c]const TSSymbol), &ts_symbol_map)),
            .alias_map = @ptrCast([*c]const u16, @alignCast(@import("std").meta.alignment([*c]const u16), &ts_non_terminal_alias_map)),
            .alias_sequences = &ts_alias_sequences[@intCast(c_uint, @as(c_int, 0))][@intCast(c_uint, @as(c_int, 0))],
            .lex_modes = @ptrCast([*c]const TSLexMode, @alignCast(@import("std").meta.alignment([*c]const TSLexMode), &ts_lex_modes)),
            .lex_fn = &ts_lex,
            .keyword_lex_fn = null,
            .keyword_capture_token = 0,
            .external_scanner = @import("std").mem.zeroes(struct_unnamed_3),
            .primary_state_ids = @ptrCast([*c]const TSStateId, @alignCast(@import("std").meta.alignment([*c]const TSStateId), &ts_primary_state_ids)),
        };
    };
...
pub const START_LEXER = @compileError("unable to translate macro: undefined identifier `result`"); // ./tree_sitter/parser.h:133:9
pub const ADVANCE = @compileError("unable to translate macro: undefined identifier `state`"); // ./tree_sitter/parser.h:145:9
pub const SKIP = @compileError("unable to translate macro: undefined identifier `skip`"); // ./tree_sitter/parser.h:151:9
pub const ACCEPT_TOKEN = @compileError("unable to translate macro: undefined identifier `result`"); // ./tree_sitter/parser.h:158:9
pub const END_STATE = @compileError("unable to translate macro: undefined identifier `result`"); // ./tree_sitter/parser.h:163:9
pub const SHIFT = @compileError("unable to translate C expr: unexpected token '{'"); // ./tree_sitter/parser.h:175:9
pub const SHIFT_REPEAT = @compileError("unable to translate C expr: unexpected token '{'"); // ./tree_sitter/parser.h:183:9
pub const SHIFT_EXTRA = @compileError("unable to translate C expr: unexpected token '{'"); // ./tree_sitter/parser.h:192:9
pub const REDUCE = @compileError("unable to translate C expr: expected ')' instead got '...'"); // ./tree_sitter/parser.h:200:9
pub const RECOVER = @compileError("unable to translate C expr: unexpected token '{'"); // ./tree_sitter/parser.h:210:9
pub const ACCEPT_INPUT = @compileError("unable to translate C expr: unexpected token '{'"); // ./tree_sitter/parser.h:215:9
...
pub inline fn SMALL_STATE(id: anytype) @TypeOf(id - LARGE_STATE_COUNT) {
...
pub const LANGUAGE_VERSION = @as(c_int, 14);
pub const STATE_COUNT = @as(c_int, 13);
pub const LARGE_STATE_COUNT = @as(c_int, 6);
pub const SYMBOL_COUNT = @as(c_int, 14);
pub const ALIAS_COUNT = @as(c_int, 0);
pub const TOKEN_COUNT = @as(c_int, 7);
pub const EXTERNAL_TOKEN_COUNT = @as(c_int, 0);
pub const FIELD_COUNT = @as(c_int, 1);
pub const MAX_ALIAS_SEQUENCE_LENGTH = @as(c_int, 3);
pub const PRODUCTION_ID_COUNT = @as(c_int, 2);
